...
if ( ! function_exists( 'presentation_lite_paging_nav' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 *
 * @return void
 */
function presentation_lite_paging_nav() {
...
if ( ! function_exists( 'presentation_lite_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 *
 * @return void
 */
function presentation_lite_post_nav() {
...
if ( ! function_exists( 'presentation_lite_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function presentation_lite_posted_on() {
 ...
 */
function presentation_lite_categorized_blog() {
	...
	if ( '1' != $all_the_cool_cats ) {
		// This blog has more than 1 category so presentation_lite_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so presentation_lite_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in presentation_lite_categorized_blog.
 */
function presentation_lite_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'all_the_cool_cats' );
}
add_action( 'edit_category', 'presentation_lite_category_transient_flusher' );
add_action( 'save_post',     'presentation_lite_category_transient_flusher' );